  ...
  return (
    <>
        <label className='border p-4 flex items-center gap-2 rounded-2xl'>
                <input type="checkbox" name='wifi' onChange={handleClick} checked={selected.includes("wifi")}/>
                ...
                <input type="checkbox" name='parking' onChange={handleClick} checked={selected.includes("parking")}/>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-7">
                ...
                <label className='border p-4 flex gap-2 items-center rounded-2xl'>
                <input type="checkbox" name='TV' onChange={handleClick} checked={selected.includes("TV")}/>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-7">
                ...
                <label className='border p-4 flex gap-2 items-center rounded-2xl'>
                <input type="checkbox" name='pets' onChange={handleClick} checked={selected.includes("pets")}/>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-7">
                ...
                <label className='border p-4 flex gap-2 items-center rounded-2xl'>
                <input type="checkbox" name='privateEntrance' onChange={handleClick} checked={selected.includes("privateEntrance")}/>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-7">
                ...
                <label className='border p-4 flex gap-2 items-center rounded-2xl'>
                <input type="checkbox" name='Radio' onChange={handleClick} checked={selected.includes("Radio")}/>
